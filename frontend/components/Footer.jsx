// components/Footer.jsx - Updated with green background
import Link from 'next/link';

export default function Footer() {
  return (
    <footer className="bg-[#132A13] text-white">
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Adaptive Atelier Logo Section - Now on green background */}
          <div className="col-span-1">
            <div className="bg-[#132A13] p-6 rounded-lg">
              <h3 className="font-amiri text-2xl font-bold mb-2">Adaptive Atelier</h3>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/docs" className="text-white/80 hover:text-white transition">
                  Documentation
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-white/80">
              Subscribe to our newsletter for accessibility tips and updates.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/20">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
            <p>© {new Date().getFullYear()} Adaptive Atelier. All rights reserved.</p>
